...
const Navbar = () => {
  ...
  const { setShowSearch, getCartCount, navigate, token, setToken, setCartItems, ecoPoints } = useContext(ShopContext)
  ...
  return (
    <div className='flex items-center justify-between py-5 font-medium relative'>
      ...
      <div className='flex items-center gap-6'>
        <Link
          to="/eco-wallet"
          className='hidden sm:flex items-center justify-center h-10 w-10 bg-green-600 hover:bg-green-500 text-white rounded-full shadow-md transition-all'
        >
          ...
          {token &&
            <div className='group-hover:block hidden absolute right-0 pt-4'>
              <div className='flex flex-col gap-2 w-40 py-3 px-5 bg-slate-100 text-gray-500 rounded shadow'>
                ...
                <Link to='/return-packaging'>
                  <p className='cursor-pointer hover:text-green-700'>♻️ Return Packaging</p>
                </Link>
